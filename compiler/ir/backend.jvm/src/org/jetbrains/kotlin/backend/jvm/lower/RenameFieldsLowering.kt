...
private class RenameFieldsLowering(val context: CommonBackendContext) : FileLoweringPass {
    override fun lower(irFile: IrFile) {
        ...
        for ((_, fields) in collector.nameToField) {
            ...
            for (field in fields.sortedByDescending { it.hasAnnotation(JvmAbi.JVM_FIELD_ANNOTATION_FQ_NAME) }) {
                ...
                if (field.hasAnnotation(JvmAbi.JVM_FIELD_ANNOTATION_FQ_NAME)) continue
