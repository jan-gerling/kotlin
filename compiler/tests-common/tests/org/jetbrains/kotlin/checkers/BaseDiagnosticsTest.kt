...
abstract class BaseDiagnosticsTest : KotlinMultiFileTestWithJava<TestModule, TestFile>() {
    ...
    inner class TestFile(
        ...
        private val diagnosedRangesMap: MutableMap<IntRange, MutableSet<String>> = mutableMapOf()
        ...
        init {
            ...
            if (fileName.endsWith(".java")) {
                ...
                this.clearText = CheckerTestUtil.parseDiagnosedRanges(addExtras(expectedText), diagnosedRanges, diagnosedRangesMap)
